...
![Figure 1: three side-by-side demo panels at identical tilt and fill](https://raw.githubusercontent.com/buildngrowsv/sixty-four-oz-straw-hinge-concept/161fdb35f31d93a1ce457d349dd03577bfc9bdc9/figures/straw-demo-three-panel-bottles.png)

**Figure 1.** Screenshot from the interactive demo in the supporting repository: same bottle geometry, waterline, and controls across panels; only the straw kinematics story changes.

![Figure 2: compliant mechanism concept diagram board](https://raw.githubusercontent.com/buildngrowsv/sixty-four-oz-straw-hinge-concept/161fdb35f31d93a1ce457d349dd03577bfc9bdc9/SixtyFourOunceStrawCompliantMechanismConceptDiagram.png)
...
Clone the supporting repository, open the main HTML file in a browser, or serve the folder with any static file host. All asset paths are relative inside the repo. Pin reviews to the commit SHA below so figure URLs and code match.
